...
{
    public partial class DividendPage : PageFunction<WizardResult>
    {
        ...
        private void PageFunction_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            AccountsComboBox.GetBindingExpression(ComboBox.SelectedItemProperty).UpdateSource();
        ...
        private void ClearInvalid()
        {
            ...
            Validation.ClearInvalid(AccountsComboBox.GetBindingExpression(ComboBox.SelectedItemProperty));
